...
void SelectReorder::operator()()
{
    ...
    auto sel1 = table.select<2, 1, 0>(table.col<0>() == 10, true);
    auto sel2 = table.select<0, 0, 0>(table.col<0>() == 10, true);
    auto sel3 = table.select<1, 1, 1>(table.col<0>() == 10, true);
    auto sel4 = table.select<2, 2, 2>(table.col<0>() == 10, true);
    auto sel5 = table.select<0, 1, 0, 1>(table.col<0>() == 10, true);
    auto sel6 = table.select<2, 1, 0, 0, 1, 2>(table.col<0>() == 10, true);
    auto sel7 = table.select<0>(table.col<0>() == 10, true);
    auto sel8 = table.select<1>(table.col<0>() == 10, true);
    auto sel9 = table.select<2>(table.col<0>() == 10, true);
